...
public class Story {
    ...
    private Situation officeParty = new Situation(
            ...
            "За такую выходку Босс выписал штраф, чем сильно задел меня, ведь я хотел сделать как лучше. Неудачное начало, ну что ж, сегодня в конторе корпоратив! \n"
    ...
    private Situation TrueWorker = new Situation("Поздравляю, Вы можете закрыть этот квест\nЯ тратил все время только на работу, коллеги странно шушукаются. Поздравляю, Я офисный планктон! Умру в одиночестве, но с баблом (что не факт)",0,2,100000,-40);
    ...
    private Situation OnMyself3 = new Situation("Я слишком увлёкся и , занявшись расследованием, забил на работу, в следствии чего меня уволили. Как оказалось, босс меня тогда не заметил",0,-1,-50000,-40);
    private Situation Silence = new Situation("Никто не отвечает\n(1)Ждать\n(2)Ворваться",2,0,0,-5);
    private Situation Wait = new Situation("Дверь приоткрыта\nЗаглядываю внутрь, а там босс убирает в шкаф шприцы и какие-то ампулы. Увидев меня, пугается, подбегает нетвердой походкой, закрывает дверь. Угрожает, просит, умоляет не говорить никому.\n(1)Согласиться\n(2)Отказаться",2,0,0,15);
